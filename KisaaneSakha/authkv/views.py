...
from sympy import O
from KisaaneSakha.settings import EMAIL_HOST_USER
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if pw1 == pw2:
                ...
                print(otp)
                subject = "KisaaneSakha Email Verification"
                msg = (
                    "Welcome "
                    + un
                    + ",\n"
                    ...
                    + str(otp)
                    + ".\n"
                    + "If you do have any futher queries, kindly contact us via email (useitelse@gmail.com).\n"
                    + "\nIf you did not initiate this verification, please ignore this email.\n"
                    + "\nRegards,\nThe KisaaneSakha Team."
                )
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if usr.last_name == "verified":
                ...
                print(fpo)
                subject = "KisaaneSakha : Forgot Password"
                msg = (
                    "Hello "
                    + em
                    + ",\n"
